...
const copy = {
  'id-ID': {
    ...
    sections: [
      ...
      ['Keamanan', 'Data akunmu hanya dapat diakses oleh akun yang kamu gunakan untuk masuk. Komunikasi produksi menggunakan HTTPS dan error log disanitasi.'],
  ...
  'en-US': {
    ...
    sections: [
      ...
      ['Security', 'Your account data can only be accessed by the account you use to sign in. Production traffic uses HTTPS and error logs are sanitized.'],
